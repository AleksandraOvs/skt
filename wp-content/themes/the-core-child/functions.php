...
function the_core_theme_enqueue()
{
	...
	if (is_page('main-page') || is_page('page-clubs')) {
		...
		wp_enqueue_script('fancy_scripts', get_stylesheet_directory_uri() . '/inc/fancybox/jquery.fancybox.min.js', array(), null, true);
